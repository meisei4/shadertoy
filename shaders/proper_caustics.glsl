...
#define ZOOM_FACTOR                 1.0     // Multiplies the pixelated UV coordinates: >1.0 zooms in, <1.0 zooms out (practical: 0.5–2.0).
...
#define TURBULENCE_INTENSITY        0.005             // Controls distortion strength (0.001–0.02).
...
#define TURBULENCE_TINT             vec3(0.0, 0.3, 0.6)  // Shifts the final color; each channel is usually in 0.0–1.0.

#define WATER_SPEED                 1.0     // Controls how fast the water patterns move (try 0.5–2.0).
#define CAUSTIC_SCALE               0.12    // Scales the UV for caustics; higher zooms in (0.05–0.2).
#define WATER_OPACITY               1.0     // Base opacity (0.0–1.0).
#define WATER1_OFFSET               -0.5    // Shifts the sampling coordinates (typically –1 to 1).
#define WATER2_OFFSET               1.0     
#define WATER1_TIME_MULTIPLIER      0.01    // Slows or speeds the water_layer_1 time shift (0.001–0.1).
#define WATER2_TIME_OFFSET_X        -0.01   // Time offsets (try –0.1 to 0.1).
#define WATER2_TIME_OFFSET_Y        -0.01

#define HIGHLIGHT_OFFSET_X1         -20.0   // Offsets for sampling highlight textures (experiment with –100 to 100).
#define HIGHLIGHT_OFFSET_Y1         100.0   
#define HIGHLIGHT_OFFSET_X2         20.0    
...
#define WARP_AMPLITUDE_X            0.05    // Sine/cosine based warp amplitude (0–0.1).
#define WARP_AMPLITUDE_Y            0.05    
...
#define WATER_AVG_THRESHOLD         1.68    // If the water brightness falls below this (0–3), the water is not rendered.
